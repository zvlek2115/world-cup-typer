      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          ...
          <div className="flex gap-2">
            <Link
              to="/individual/all-predictions"
              className="flex items-center bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md font-bold transition-all shadow-lg text-sm"
            >
        ...
        <h1 className="text-3xl font-bold flex items-center justify-center mb-8">
